...
// Simple Icons SVG paths for streaming services
const brandIcons = {
  netflix: (
  ...
  appletv: (
    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      <path d="M18.996 16.063c-.452 1.073-1.667 3.107-3.104 3.107-1.135 0-1.514-.758-2.821-.758-1.306 0-1.737.738-2.82.778-1.389.04-2.455-1.654-3.168-2.926-1.236-2.205-1.474-4.8-.651-6.177.581-.975 1.508-1.545 2.379-1.545 1.033 0 1.682.758 2.536.758.828 0 1.332-.76 2.523-.76.795 0 1.606.434 2.131 1.184-1.873 1.03-1.569 3.712.366 4.43-.296.757-.69 1.427-1.099 1.909h-.272zM14.4 4.02c.63-.758 1.1-1.826.98-2.913-.948.04-2.062.653-2.72 1.431-.596.697-1.087 1.765-.898 2.795 1.045.08 2.006-.57 2.638-1.313z M9.504 20.88h1.114l.26-.8h1.363l.26.8h1.136l-1.3-3.714h-1.232l-1.6 3.714zm1.67-1.54l.26-.81c.074-.22.162-.52.26-.89h.02l.26.89.26.81h-1.06zm4.082 1.54h1.05v-1.17h.58c.87 0 1.456-.52 1.456-1.28 0-.75-.57-1.264-1.39-1.264h-1.696v3.714zm1.05-1.97v-.94h.46c.33 0 .53.18.53.47 0 .29-.2.47-.53.47h-.46z" />
    </svg>
  ),
  paramountplus: (
    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      <path d="M12.062 0L.46 20.448h3.994l2.164-3.84h5.092L9.29 20.448h4.006l2.408-3.84h5.14l2.164 3.84H24L12.062 0zm-.032 6.156l2.82 4.956H9.198l2.832-4.956zM0 22.608v1.392h24v-1.392H0z" />
    </svg>
  ),
  hulu: (
    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  hbomax: (
    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      <path d="M7.042 16.995H4.414v-3.74H1.622v3.74H0V7.83h1.622v3.74h2.792V7.83h2.628v9.165zm6.19-3.73c.51-.378.85-.986.85-1.72 0-1.472-1.133-2.626-2.7-2.626H7.976v9.076h3.594c1.567 0 2.7-1.154 2.7-2.627 0-.85-.425-1.567-1.038-1.963v-.14zm-2.087-2.25c.566 0 .992.425.992.992 0 .566-.426.99-.992.99H9.598v-1.982h1.547zm.236 5.347H9.598v-1.982h1.783c.566 0 .992.425.992.991s-.426.99-.992.99zm8.23-3.209c-1.076 0-2.011.52-2.59 1.32-.578-.8-1.514-1.32-2.589-1.32-1.755 0-3.181 1.425-3.181 3.18s1.426 3.181 3.18 3.181c1.076 0 2.012-.52 2.59-1.32.578.8 1.514 1.32 2.59 1.32 1.754 0 3.18-1.426 3.18-3.18 0-1.756-1.426-3.181-3.18-3.181zm-5.179 4.395c-.67 0-1.214-.544-1.214-1.214 0-.671.544-1.214 1.214-1.214.67 0 1.214.543 1.214 1.214 0 .67-.543 1.214-1.214 1.214zm5.18 0c-.671 0-1.215-.544-1.215-1.214 0-.671.544-1.214 1.214-1.214.67 0 1.214.543 1.214 1.214 0 .67-.544 1.214-1.214 1.214z" />
    </svg>
  ),
  cnn: (
    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      <path d="M24 12c0 6.627-5.373 12-12 12S0 18.627 0 12 5.373 0 12 0s12 5.373 12 12zM5.5 8h-1v8h1v-3h2v3h1V8h-1v3.5h-2V8zm5 0h-1v8h2.5v-1H10.5V8zm6.5 0h-1v8h1v-6l2 6h1V8h-1v6l-2-6z" />
    </svg>
  ),
} as const;
...
// Export for reuse
export { videoServices, additionalServices, brandIcons };
