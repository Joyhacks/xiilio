...
export const Footer = forwardRef<HTMLElement, React.HTMLAttributes<HTMLElement>>(
  ...
  return (
    <>
      <footer ref={ref} {...props} className="py-4 border-t border-primary/10 -mt-4 pb-20 md:pb-4" style={{ backgroundColor: '#0c1709', paddingLeft: 'var(--safe-area-left)', paddingRight: 'var(--safe-area-right)' }}>
